...
p.webkitAudioContext||p.mozAudioContext;return function(){var b=new a;b.createGain=b.createGainNode=b.createGain||b.createGainNode;b.createDelay=b.createDelayNode=b.createDelay||b.createDelayNode;b.createScriptProcessor=b.createJavaScriptNode=b.createScriptProcessor||b.createJavaScriptNode;var d=b.createGain().gain.__proto__.__proto__;d.setTargetAtTime=d.setTargetValueAtTime=d.setTargetAtTime||d.setTargetValueAtTime;d=b.createBufferSource().__proto__;d.start=d.noteOn=d.start||d.noteOn;d.stop=d.noteOff=
d.stop||d.noteOff;d=b.createOscillator().__proto__;d.start=d.noteOn=d.start||d.noteOn;d.stop=d.noteOff=d.stop||d.noteOff;return b}}catch(b){}}function o(){try{var a=p.performance,b=a&&(a.now||a.webkitNow||a.mozNow);return b?function(){return 0.0010*b.call(a)}:function(){return 0.0010*Date.now()}}catch(c){}}var z=function(){var a={};return function(b){if(a[b])throw Error("Invalid event name - "+b);return b}}(),J=1;u.observe=function(a,b,c){var c=z(c||b),d=a[b];a[b]=function(){var a=d.apply(this,arguments),
b=Array.prototype.slice.call(arguments);b.unshift(c);this.emit.apply(this,b);return a};return a};var L=function(){function a(g,d,c){g.inputs=d||[];g.outputs=c||[];g.numberOfInputs=g.inputs.length;g.numberOfOutputs=g.outputs.length;g.context=g.inputs[0]&&g.inputs[0].context||g.outputs[0]&&g.outputs[0].context;g.connect=function(a,b,d){var c,a=a||g.context.destination,b=g.outputs[b||0];c=a.inputs?a.inputs[d||0]:a;if("AudioParam"===c.constructor.name||"AudioGain"===c.constructor.name)b.connect(c);else if(c.numberOfInputs===
b.numberOfOutputs){a=0;for(d=c.numberOfInputs;a<d;++a)b.connect(c,a,a)}else b.connect(c);return g};g.disconnect=function(){0<arguments.length?Array.prototype.forEach.call(arguments,function(a){g.outputs[a].disconnect()}):g.outputs.forEach(function(a){a.disconnect()});return g};var e={},h=b(g);g.keep=function(a){var a=a||g,d=b(a);return e[d]=a};g.drop=function(d){d?(d=b(d),delete e[d]):delete a._preservedNodes[h]};a._preservedNodes[h]=e;return g}function b(a){var b=a[d];b||(b=c++,Object.defineProperty(a,
d,{value:b,writable:!1,enumerable:!1,configurable:!1}));return b}var c=1,d="#org.anclab.steller.GraphNode.globalid";a._preservedNodes={};a.chain=function(b){var d,c;d=0;for(c=b.length-1;d<c;++d)b[d].connect(b[d+1]);return a};return a}();j.getters={value:function(){return this._value},audioParam:function(){return this.audioParam.value}};j.setters={value:function(a){return this._value=a},audioParam:function(a){return this.audioParam.value=a},option:function(a){return this._value=this.spec.limit(a)}};
j.mappings={};j.mappings.linear={fromNorm:function(a,b){return a.spec.min+b*(a.spec.max-a.spec.min)},toNorm:function(a){return(a.value-a.spec.min)/(a.spec.max-a.spec.min)}};j.mappings.log={fromNorm:function(a,b){var c=a.spec,d=Math.log(c.min),c=Math.log(c.max);return Math.exp(d+b*(c-d))},toNorm:function(a){var b=a.spec,c=Math.log(b.min),b=Math.log(b.max);return(Math.log(a.value)-c)/(b-c)}};j.names=function(a){return Object.keys(a).filter(function(b){return a[b]instanceof j})};j.expose=function(a,
b,c){c||(c=j.names(a));c.forEach(function(d){b[d]=a[d]});return j};j.bind=function(a,b,c){a instanceof j?a.bind(b,c):"value"in a?c?c.update(function(){b.value=a.value}):b.value=a.value:c?c.update(function(){b.value=a}):b.value=a;return j};j.prototype.__defineGetter__("value",function(){return this.getter()});j.prototype.__defineSetter__("value",function(a){return a!==this.getter()?n(this,this.setter(a)):a});j.prototype.watch=function(a){var b,c,d=this.watchers;b=0;for(c=d.length;b<c;++b)if(d[b]===
a)return this;d.push(a);return this};j.prototype.unwatch=function(a){var b=this.watchers;if(1>arguments.length||!a)return b.splice(0,b.length),this;for(var c=b.length-1;0<=c;--c)if(b[c]===a){b.splice(c,1);break}return this};j.prototype.changed=function(){n(this,this.getter());return this};j.prototype.alias=function(a,b){var c=this,d=Object.create(c);d.spec=Object.create(c.spec);d.spec.name=a;b&&(d.spec.label=b);d.getter=function(){return c.getter()};d.setter=function(a){return c.setter(a)};d.alias=
function(a,b){return c.alias(a,b)};return d};j.prototype.bind=function(a,b){var c=this;if(a.addEventListener){var d=c.spec,g=d.mapping?j.mappings[d.mapping]:j.mappings.linear,e,h,f;if("checkbox"===a.type)e=function(){c.value=a.checked?1:0},h=b?function(){b.update(e)}:e,f=function(b){a.checked=b?!0:!1};else if("range"===a.type)e=function(){c.value=g.fromNorm(c,parseFloat(a.value))},h=b?function(){b.update(e)}:e,f=function(){a.value=g.toNorm(c)};else throw Error("org.anclab.steller.Param.bind: Unsupported control type - "+
...
var g=d.__steller_async_eventable__;g||Object.defineProperty(d,"__steller_async_eventable__",{value:g=function(){var b=arguments;setTimeout(function(){d.apply(a,b)},0)},enumerable:!1,configurable:!1,writable:!1});b(c,g)};return a};r.GraphNode=L;r.SoundModel=function(a,b,c){a=u(L(a,b,c));u.observe(a,"connect");u.observe(a,"disconnect");return a};r.Param=j;r.Scheduler=function(a,b){function c(a,b){a&&(A.add(a),A.add(b))}function d(a){a(l,v.copy(),g)}function g(){}function f(a,b,d){d&&d(a,b,g)}function n(a,
b){return function(d,c,e){function h(d,c){var y=o+a.valueOf();0<B&&c.t1<v.t1&&c.advance(B);c.t1>F?f&&C.add(f):c.t2r<y?(b&&b(c,c.t1r,c.t2r,o,y),c.tick(),f&&C.add(f)):(b&&y>=c.t1r&&b(c,c.t1r,y,o,y),c.t2r>c.t1r?e(d,c.nudgeToRel(y),g):e(d,c,g))}function f(a){h(a,c,g)}var o=c.t1r;h(d,c)}}function k(a){return function(b,c,d){a(c)(b,c,d)}}function z(a){function b(a,d,e){var f,h,E;if(0<c.length){E=c;c=[];f=0;for(h=E.length;f<h;++f)E[f](a,d.copy(),g)}e(a,d,g)}if(0<arguments.length)return function(a,b,c){for(;a<
b;++a)c.push(z());return c}(0,a,[]);var c=[];b.play=function(a){c.push(a);return this};b.cancel=function(){c.splice(0,c.length);return this};return b}function J(a){function b(a,d,f){e?f(a,d,g):c.push({sched:a,next:f,clock:d})}if(0<arguments.length)return function(a,b,c){for(;a<b;++a)c.push(J());return c}(0,a,[]);var c=[],d=[],e=!0;b.__defineGetter__("isOpen",function(){return e});b.__defineSetter__("isOpen",function(a){a?b.open():b.close();return a});b.open=function(a,b,d){e=!0;var f=c,h,E,o,i=D();
c=[];h=0;for(E=f.length;h<E;++h)o=f[h],o.next(o.sched,b?b.copy():o.clock.advanceTo(i),g);d&&d(a,b,g)};b.close=function(a,b,c){e=!1;c&&c(a,b,g)};b.toggle=function(a,c,d){return e?b.close(a,c,d):b.open(a,c,d)};b.cancel=function(a,b,d){c.splice(0,c.length);d&&d(a,b,g)};b.push=function(a,b,f){d.push({isOpen:e,cache:c});c=[];f&&f(a,b,g)};b.pop=function(a,b,e){var f=d.pop();c.push.apply(c,f.cache);this.isOpen=f.isOpen;e&&e(a,b,g)};return b}var l=this===p?{}:this,L=e(),r=s();if(h()&&!L)throw Error("Scheduler needs requestAnimationFrame support. Use a sufficiently modern browser version.");
var M=0.0010,D=function(){if(a){if(a instanceof r)return M=1/a.sampleRate,a.createGainNode(),function(){return a.currentTime};throw Error("Scheduler: Argument is not an audio context");}return o()||function(){return 0.0010*Date.now()}}(),w,q=!1;l.__defineGetter__("running",function(){return q});l.__defineSetter__("running",function(a){a?q||(q=!0,v.advanceTo(D()),w.start()):(q=!1,w.stop())});l.frame_rate=j({min:15,max:75,value:60});var C=new t("tick"),A=new t("frames"),u=new t("update");w=new m(function(){var a,
b,c,d,g;a=!0;b=D();W(b);for(F=b+G;b-v.t1>T;)B=b-v.t1,v.advance(B);for(;a||v.t1<F;){if(0<u.length){c=u.length;for(a=0;a<c;++a)u.remove()()}c=C.length;for(a=0;a<c;++a)C.remove()(l,v,f);v.t1<F&&v.tick();B=0;a=!1}if(0<A.length){c=A.length;for(a=0;a<c;a+=2)d=A.remove(),g=A.remove(),d(b,g)}if(l.ontick)l.ontick(b)},0,a);var I=1/60,N=I,G=w.computeAheadInterval_secs||0.05,T=5*G,v=new i(D(),0,G,1),F=v.t1,B=0,W=function(){var a=1/60,b=v.t1,c=15;return function(d){var g=d-b;0.01<g&&0.07>g&&(N=I=a+=0.05*(g-a),
G=3.33*I,T=5*G,0>=c--&&(l.frame_rate.value=Math.round(1/I),c=15));b=d}}(),U=function(){return a?function V(b){0===a.currentTime?setTimeout(V,100,b):(v=new i(D(),0,G,1),F=v.t1,l.play=U=d,d(b))}:d}(),O;b&&b.diagnostics?(4<=LOG_LEVEL&&console.log("scheduler.js[630]:\t","fire: diagnostics on"),O=function(a){return function(b,c,d){D();a(c);d(b,c,g)}}):O=function(a){return function(b,c,d){a(c);d(b,c,g)}};l.audioContext=a;l.update=function(a){a&&u.add(a)};l.perform=function(a,b,c){a(l,b,c)};l.cancel=function(){u.clear();
C.clear();A.clear()};l.play=U;l.stop=g;l.cont=f;l.delay=n;l.loop=function(a){return function y(b,c){a(b,c,y)}};l.loop_while=function(a,b){return function(c,d,e){function f(){a.valueOf()?b(c,d,f):e(c,d,g)}f()}};l.repeat=function(a,b){return function(c,d,e){function f(){if(h<a){h++;b(c,d,f)}else e(c,d,g)}var h=0;f()}};l.fork=function(a){a=a&&a.constructor===Function?Array.prototype.slice.call(arguments,0):a.slice(0);return function(b,c,d){function e(b,h){f++;f===a.length&&d(b,c.syncWith(h),g)}var f=
0;a.forEach(function(a){a(b,c.copy(),e)})}};l.spawn=function(a){a=a&&a.constructor===Function?Array.prototype.slice.call(arguments,0):a.slice(0);return function(b,c,d){a.forEach(function(a){a(b,c.copy(),g)});d(b,c,g)}};l.dynamic=k;l.track=function(a){function b(c,d,e,f,h){function o(b,c){if(i<l)a[i++](b,c,o);else e(b,c,g)}var i=0,l=a.length;if(arguments.length>3){i=f;l=h}o(c,d,e)}a&&a.constructor===Function&&(a=Array.prototype.slice.call(arguments,0));b.minIndex=0;b.maxIndex=a.length;b.models=a;return b};
l.slice=function(a,b,c){c=arguments.length>2?c:a.maxIndex;b=arguments.length>1?Math.max(a.minIndex,Math.min(b,c)):a.minIndex;return function(d,g,e){a(d,g,e,b,c)}};l.fire=O;l.display=function(a){return function(b,d,e){function f(b){b+N>h?a(d,h,b):c(f)}var h=d.t1;c(f);e(b,d,g)}};l.frame=function(a){return function(b,d,e){function f(o){if(o+N>h){d.jumpTo(o);a(d);e(b,d,g)}else c(f)}var h=d.t1;c(f)}};l.frames=function(a,b){return function(d,e,f){function h(b,c){var d,e=i+a.valueOf();if(B>0&&c.t1<v.t1){c.advance(B);
if(k){m=m+void 0;k.intervals.length>4&&k.intervals.splice(0,k.intervals.length-4);if(k.intervals.length>0){k.intervals[0]=k.intervals[0]+void 0;k.intervals[3]=c.rate.valueOf()}}}if(c.t1>F)o&&C.add(o);else{if(k&&c.t1r<=e){k.endTime=e;var n=c.rate.valueOf();for(d=Math.max(0.0010,I*n);l<c.t2r;){k.intervals.push(m);k.intervals.push(l);k.intervals.push(l+d);k.intervals.push(n);l=l+d}}if(c.t2r<e){c.tick();o&&C.add(o)}else{k.end=true;c.t2r>c.t1r?f(b,c.nudgeToRel(e),g):f(b,c,g)}}}function o(a){h(a,e,g)}var i=
e.t1r,l=i,m=e.t1,n,k;if(b){n=function(a,d){if(d.intervals.length>0){var e=d.intervals[0],g=d.intervals[1],f=d.intervals[2],h=d.intervals[3];if(g<=d.endTime){if(e<N+a){b(d.clock,g,f,d.startTime,d.endTime,h);d.intervals.splice(0,4)}c(n,d);return}}d.end||c(n,d)};k={clock:e,intervals:[],startTime:e.t1r,endTime:e.t1r+a.valueOf(),end:false};c(n,k)}h(d,e)}};l.log=function(a){return O(function(){console.log(a)})};l.anim=function(a,b){var c,d,e,g;switch(arguments.length){case 3:g=arguments[2];break;case 4:c=
arguments[2];d=arguments[3];g=function(a){return(1-a)*c.valueOf()+a*d.valueOf()};break;case 5:c=arguments[2];d=arguments[3];e=arguments[4];g=function(a){a=e(a);return(1-a)*c.valueOf()+a*d.valueOf()};break;default:throw Error("Invalid arguments to anim()");}return a.constructor.name==="AudioGain"||a.constructor.name==="AudioParam"?n(b,function(b,c,d,e,f){var f=f-e,h;if(c<=e){h=f>M?(c-e)/f:0;a.setValueAtTime(g(h),b.rel2abs(c))}a.linearRampToValueAtTime(g(f>M?(d-e)/f:1),b.rel2abs(d))}):n(b,function(b,
c,d,e,f){b=f-e-(d-c);a.value=b>M?g((c-e)/b):g(1)})};l.rate=function(a){return function(b,c,d){c.rate=a;d(b,c,g)}};l.choice=function(a){return k(function(){return a[Math.floor(Math.random()*a.length)]})};l.sync=z;l.gate=J;l.stats=function(){return{frame_jitter_ms:0}};l.running=b&&"running"in b&&b.running||!0;org.anclab.steller.Models&&(l.models=org.anclab.steller.Models(l));return l};r.Clock=i;r.PeriodicTimer=m;r.JSNodeTimer=function(a,b,c){if(c){var d=c.createJavaScriptNode(1024);d.onaudioprocess=
function(){a()};var e=this,f=!1;k(d);e.start=function(){f||(f=!0,d.connect(c.destination))};e.stop=function(){f&&(d.disconnect(),f=!1)};e.__defineGetter__("running",function(){return f});e.__defineSetter__("running",function(a){a?e.start():e.stop();return f});e.computeAheadInterval_secs=Math.round(2560)/c.sampleRate;return e}return m.call(this,a,b)};r.UI=w;r.Util={p2f:function(a){return 440*Math.pow(2,(a.valueOf()-69)/12)},f2p:function(a){a=69+12*Math.log(a.valueOf()/440)/Math.LN2;return Math.round(100*
a)/100},augment:function(a,b){var c=org.anclab.steller;if(a in c)c[a].augmentors.push(b);else{var d=function(){var a=Array.prototype.slice.call(arguments,0),b={};d.augmentors.forEach(function(c){b=c.apply(b,a)||b});return b};d.augmentors=[b];c[a]=d}return c[a]}};r.requestAnimationFrame=function(a){return function(b){return a(b)}}(e());r.AudioContext=s()})(function(){return"undefined"===typeof window?void 0:window}(),org.anclab.steller);
...
null;a.playbackTime=n.currentTime;var d=!1,g=!1,P=0,Q=Infinity,R,x=j({},p,u),K=0<w.length?t.dc(1):void 0;w.forEach(function(a,b){var c=p[k+b];x[a]=c.gain;c.gain.value=m.audioParams[a];K.connect(c)});var l=x.keep(n.createScriptProcessor(m.bufferLength||512,i,Math.min(1,f)));h&&h.connect(l);l.onaudioprocess=function(d){var e,h,i,j,l;e=0;if(!g){var o=d.outputBuffer.length;i=Math.floor(n.currentTime*n.sampleRate);j=Math.max(i,P);l=i+o;var p=j-i;i=l-i;if(l>j){e=0;for(h=k;e<h;++e)b[e]=d.inputBuffer.getChannelData(e).subarray(p,
i);e=0;for(h=f;e<h;++e)c[e]=d.outputBuffer.getChannelData(e).subarray(p,i);e=0;for(h=w.length;e<h;++e)a[w[e]]=d.inputBuffer.getChannelData(k+e).subarray(p,i);a.playbackTime=(d.playbackTime||n.currentTime)+p/n.sampleRate;a.samplesToStop=Q-j;e=m.onaudioprocess.call(x,a);void 0===e&&(e=l-j)}j+e<l&&(1<=LOG_LEVEL&&console.log("models/jsnode.js[168]:\t","Finished",l,Q),g=!0,setTimeout(R,Math.round(1E3*o/n.sampleRate)))}};var S=e||n.destination;R=function(){g=!0;l.disconnect();e&&e.disconnect();K&&(K.stop(0),
K.disconnect());h&&h.disconnect();x.drop(l);x.emit&&x.emit("finished")};var H;x.prepareAheadTime=0.1;x.start=function(a){if(!d&&!g)if(a){var b=Math.max(a,n.currentTime)-n.currentTime;H&&(cancelTimeout(H),H=null);var c=function(a){P=Math.floor(a*n.sampleRate);d=true;H=null;l.connect(S)};b<=x.prepareAheadTime?c(a):H=setTimeout(c,Math.round(1E3*(b-x.prepareAheadTime)),a)}else d=!0,l.connect(S)};x.stop=function(a){g||(Q=Math.max(P,Math.ceil(a*n.sampleRate)))};0<k&&x.start(0);return x};return t});
