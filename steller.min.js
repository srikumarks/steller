...
d.stop||d.noteOff;d=b.createOscillator().__proto__;d.start=d.noteOn=d.start||d.noteOn;d.stop=d.noteOff=d.stop||d.noteOff;return b}}catch(b){}}function o(){try{var a=p.performance,b=a&&(a.now||a.webkitNow||a.mozNow);return b?function(){return 0.0010*b.call(a)}:function(){return 0.0010*Date.now()}}catch(c){}}var z=function(){var a={};return function(b){if(a[b])throw Error("Invalid event name - "+b);return b}}(),I=1;u.observe=function(a,b,c){var c=z(c||b),d=a[b];a[b]=function(){var a=d.apply(this,arguments),
b=Array.prototype.slice.call(arguments);b.unshift(c);this.emit.apply(this,b);return a};return a};var K=function(){function a(g,d,c){g.inputs=d||[];g.outputs=c||[];g.numberOfInputs=g.inputs.length;g.numberOfOutputs=g.outputs.length;g.context=g.inputs[0]&&g.inputs[0].context||g.outputs[0]&&g.outputs[0].context;g.connect=function(a,b,d){var c,a=a||g.context.destination,b=g.outputs[b||0];c=a.inputs?a.inputs[d||0]:a;if("AudioParam"===c.constructor.name||"AudioGain"===c.constructor.name)b.connect(c);else if(c.numberOfInputs===
